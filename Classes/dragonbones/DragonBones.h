...
#define PROPERTY_Get_REF( T, varName)				\
public: const T& get##varName() const {return varName;}

#define PROPERTY_Get_value( T, varName)				\
public:  T get##varName() const {return varName;}
