...
DBAnimation* Armature::getAnimation() const
{
    return _animation;
}
...
Armature::Armature(ArmatureData *armatureData, DBAnimation *animation, IEventDispatcher *eventDispatcher, void *display)
...
void Armature::sortBones()
{
    ...
    auto l = _boneList.size();
    sortedList.clear();
    sortedList.reserve(l);
...
void Armature::_sendAllEventImmediately()
{
}
